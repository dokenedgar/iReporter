...
var RedFlag = {
  ...
  editLocationRedFlag: function editLocationRedFlag(req, res) {
    ...
    var result = _redflagModel.newRedFlagObject.editRedFlagLocation(req.params.id, req.body.latitude, req.body.longitude);
  ...
  editCommentRedFlag: function editCommentRedFlag(req, res) {
    ...
    var result = _redflagModel.newRedFlagObject.editRedFlagComment(req.params.id, req.body.comment);
  ...
  deleteRedFlag: function deleteRedFlag(req, res) {
    ...
    var result = _redflagModel.newRedFlagObject.deleteRedFlag(req.params.id);

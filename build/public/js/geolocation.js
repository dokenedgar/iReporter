...
var locationSelectButton = document.getElementById("location");
...
function showPosition(position) {
    ...
    map = new google.maps.Map(document.getElementById('mapHolder'), { zoom: 15, center: userLocation });
...
var createRedFlag = function createRedFlag() {
    window.location.href = 'profile.html';
};

var createIntervention = function createIntervention() {
    window.location.href = 'profile.html';
};